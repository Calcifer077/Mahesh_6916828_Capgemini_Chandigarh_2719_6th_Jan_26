namespace CompareTwoArraysAndStoreGreaterQuestion6
{
    internal class Program
    {
        ...
        // compare two arrays and store the greater elements into output array
        public void Question()
        {
            ...
            else
            {
                for (int i = 0; i < inputArray1Size; i++)
                {
                    ...
                    {
                        output[i] = inputArray1[i];
                    }
                    else
                    {
                        output[i] = inputArray2[i];
                    }
                }
            }
